# Chat Engine Development Roadmap
...
**Current Status**: 
- ✅ Layer 0: Chat engine, streaming, markdown, file browsing, doc fetching, self-building complete (138 tests passing)

**Next Phase**: 
- Layer 1 (Core Enhancements) - Recommended to start here for foundational improvements
